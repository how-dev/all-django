...
class UserResource(resources.ModelResource):
    id = fields.Field(attribute="id", column_name="User ID", widget=CharWidget())
    last_login = fields.Field(
        attribute="last_login", column_name="Last Login", widget=DateTimeWidget()
    )
    is_active = fields.Field(
        attribute="is_active", column_name="Is Active", widget=CharWidget()
    )
